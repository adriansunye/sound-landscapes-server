...
var (
	...
	// ? Add the Advertisement Service, Controllers and Routes
	...
	AdvertisementRouteController routes.AdvertisementRouteController
)
...
func init() {
	...
	// ? Add the Advertisement Service, Controllers and Routes
	advertisementCollection = mongoclient.Database("golang_mongodb").Collection("advertisements")
	advertisementService = services.NewAdvertisementService(advertisementCollection, ctx)
	AdvertisementController = controllers.NewAdvertisementController(advertisementService)
	AdvertisementRouteController = routes.NewAdvertisementControllerRoute(AdvertisementController)
...
func startGinServer(config config.Config) {
	...
	// ? Evoke the AdvertisementRoute
	AdvertisementRouteController.AdvertisementRoute(router)
